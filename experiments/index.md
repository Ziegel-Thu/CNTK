...
| --- | --- | --- | --- | --- | --- |
| 001 | spectral-tail-diagnostics | P0 | toy + image subsets complete | Does local mixing predict spectral tail and slow kernel flow? | CPU first, GPU optional |
| 002 | feature-metric-dynamics | P1 | toy quick complete | Does feature learning reduce mixing/tail by changing `K_t`? | GPU preferred |
