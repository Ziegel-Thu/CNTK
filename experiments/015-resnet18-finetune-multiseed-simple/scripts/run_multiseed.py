#!/usr/bin/env python3
"""Small multi-seed ResNet18 fine-tuning dynamics run."""
...
EXP_DIR = ROOT / "experiments" / "015-resnet18-finetune-multiseed-simple"
...
def main() -> None:
    ...
    plot_results(finals)
    command = "python3 experiments/015-resnet18-finetune-multiseed-simple/scripts/run_multiseed.py"
    if args.quick:
        command += " --quick"
    else:
